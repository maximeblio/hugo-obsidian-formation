...
En novembre 2025, **plus de 2 200 plugins** étaient diponibles sur Obsidian. S'ils peuvent apporter une véritable plus value dans votre utilisation du logiciel, attention de ne pas trop en abuser !

Une trop grande présence de plugins peut entraîner un ralentissement d'Obsidian. Mais trop complexifier les fonctionnalités peut aussi devenir contre productif à terme.

Voici une sélection de plugins présentés durant la formation, ou qui pourraientt vous être utiles.

{{< alert cardColor="#e63946" iconColor="#1d3557" textColor="#f1faee" >}}
**Attention :** les liens renvoient vers les pages GiHub des plugins pour que vous ayez accès à la documentation des créateurs et créatrices. **Ils sont à installer directement depuis Obsidian**. 
{{< /alert >}}
...
Day Planner est un calendrier éditable et qui permet une gestion par blocs de temps de sa journée. Il permet notament une intégration avec des calendriers en ligne, comme Google Calendar.

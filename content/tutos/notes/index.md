...
Avec le module [Bases](/bases#bases), il est posible d'afficher dans sa **note quotidienne** les notes créées et modifiées du jour.
...
Attention ! Cliquez en dehors du champs `Filter`, et non sur le logo avec la petit flèche pour prendre en compte la formule !
{{< /alert >}}
